...
describe('UsagePage toolbar styles', () => {
  ...
  it('keeps Sign out as the rightmost header action after Check Updates', () => {
    expect(usagePageSource).toContain("fetchStatus, fetchUpdateCheck, fetchUsageEventModelFilterOptions, fetchUsageEventSourceFilterOptions, fetchUsageEvents, logout, markStatusActive, updateCpaApiKeyAlias } from '@/lib/api';")
