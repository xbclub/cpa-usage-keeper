...
func TestListUsageEventsWithFilterAppliesTimeBoundsAndPagination(t *testing.T) {
	...
	page, err := ListUsageEventsWithFilter(db, dto.UsageQueryFilter{StartTime: &start, EndTime: &end, Page: 1, PageSize: 1}, pricingResolverFromDBForTest(t, db))
	if err != nil {
...
func TestListUsageEventsWithFilterFindsProjectTimezoneStorageTimestamp(t *testing.T) {
	...
	page, err := ListUsageEventsWithFilter(db, dto.UsageQueryFilter{StartTime: &start, EndTime: &end, Page: 1, PageSize: 20}, pricingResolverFromDBForTest(t, db))
	if err != nil {
		t.Fatalf("ListUsageEventsWithFilter returned error: %v", err)
	}
...
func TestListUsageEventsWithFilterPagesByTimestampAndID(t *testing.T) {
	...
	firstPage, err := ListUsageEventsWithFilter(db, dto.UsageQueryFilter{Page: 1, PageSize: 1}, pricingResolverFromDBForTest(t, db))
	if err != nil {
		t.Fatalf("ListUsageEventsWithFilter returned error: %v", err)
	}
	secondPage, err := ListUsageEventsWithFilter(db, dto.UsageQueryFilter{Page: 2, PageSize: 1}, pricingResolverFromDBForTest(t, db))
	if err != nil {
		t.Fatalf("ListUsageEventsWithFilter returned error: %v", err)
	}
...
func TestListUsageEventsWithFilterAppliesModelAuthIndexAndResultFilters(t *testing.T) {
	...
	page, err := ListUsageEventsWithFilter(db, dto.UsageQueryFilter{Page: 1, PageSize: 20, Models: []string{"claude-sonnet"}, AuthIndex: "auth-a", Result: "success"}, pricingResolverFromDBForTest(t, db))
	if err != nil {
		t.Fatalf("ListUsageEventsWithFilter returned error: %v", err)
	}
...
func TestListUsageEventsWithFilterAppliesAuthIndexFilter(t *testing.T) {
	...
	page, err := ListUsageEventsWithFilter(db, dto.UsageQueryFilter{AuthIndex: "auth-1", Page: 1, PageSize: 20}, pricingResolverFromDBForTest(t, db))
	if err != nil {
		t.Fatalf("ListUsageEventsWithFilter returned error: %v", err)
	}
