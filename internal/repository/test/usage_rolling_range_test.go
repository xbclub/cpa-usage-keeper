...
func TestBuildAnalysisIncludesCurrentHourStatsForArbitraryHourRange(t *testing.T) {
	...
	analysis, err := repository.BuildAnalysisWithFilter(db, repodto.UsageQueryFilter{Range: "13h", StartTime: &start, EndTime: &end}, pricingResolverFromDBForTest(t, db))
...
func TestBuildAnalysisIncludesCurrentHourStatsForRollingDayRange(t *testing.T) {
	...
	analysis, err := repository.BuildAnalysisWithFilter(db, repodto.UsageQueryFilter{Range: "13d", StartTime: &start, EndTime: &end}, pricingResolverFromDBForTest(t, db))
...
func TestBuildAnalysisKeepsDailyStatsAcrossDSTBoundary(t *testing.T) {
	...
	analysis, err := repository.BuildAnalysisWithFilter(db, repodto.UsageQueryFilter{Range: "8d", StartTime: &start, EndTime: &end}, pricingResolverFromDBForTest(t, db))
